...
CLOSE-131A closure evidence:

- `signal_agent/transport/schemas/models.py`
- `signal_agent/transport/schemas/__init__.py`
- `.\.venv\Scripts\python.exe -B -m py_compile signal_agent\transport\schemas\models.py signal_agent\transport\schemas\__init__.py` passed.
- `git diff --check -- signal_agent/transport/schemas/models.py signal_agent/transport/schemas/__init__.py` passed.
- Import review found only stdlib imports plus the local schema re-export.
