...
class DecisionOutcome(str, Enum):
    ...
    ADMIT_SOURCE_PACKET = "ADMIT_SOURCE_PACKET"
    ...
    REJECT_MISSING_HUMAN_REVIEW = "REJECT_MISSING_HUMAN_REVIEW"
    REJECT_SELF_CERTIFICATION = "REJECT_SELF_CERTIFICATION"
    REJECT_SELF_APPROVAL = "REJECT_SELF_APPROVAL"
    REJECT_MISSING_ROLLBACK = "REJECT_MISSING_ROLLBACK"
    BLOCK_DUPLICATE = "BLOCK_DUPLICATE"
    EMIT_PROVISIONAL_DRAFT = "EMIT_PROVISIONAL_DRAFT"
